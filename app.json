{
  "name": "your bot name",
  "description": "Javascript WhatsApp bot made your name",
  "logo": "https://files.catbox.moe/82b8gr.jpg",
  "keywords": ["INCONNU-XD"],
  "success_url": "/",
  ...
  "env": {
    ...
    "AUTO_STATUS_MSG": {
      ...
      "required": true,
      "value": "*SEEN YOUR STATUS BY INCONNU XD*"
   ...
   "MENTION_REPLY": {
    ...
    "MENU_IMAGE_URL": {
      ...
      "required": false,
      "value": "https://files.catbox.moe/82b8gr.jpg"
    },
    
     "DESCRIPTION": {
      "description": "add caption for menu and other",
      "required": false,
      "value": "> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɢᴏᴛᴀʀ ᴛᴇᴄʜ*"
    },
